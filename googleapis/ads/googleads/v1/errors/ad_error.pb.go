...
func (AdErrorEnum_AdError) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_69091a5966fb9a14, []int{0, 0}
}
...
func (*AdErrorEnum) Descriptor() ([]byte, []int) {
	return fileDescriptor_69091a5966fb9a14, []int{0}
}
...
func init() {
	proto.RegisterFile("google/ads/googleads/v1/errors/ad_error.proto", fileDescriptor_69091a5966fb9a14)
}

var fileDescriptor_69091a5966fb9a14 = []byte{
