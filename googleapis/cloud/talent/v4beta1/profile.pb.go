...
func (Phone_PhoneType) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_f0277fc1d2fabb3b, []int{4, 0}
}
...
func (Skill_SkillProficiencyLevel) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_f0277fc1d2fabb3b, []int{10, 0}
}
...
func (JobApplication_ApplicationStatus) EnumDescriptor() ([]byte, []int) {
	return fileDescriptor_f0277fc1d2fabb3b, []int{14, 0}
}
...
func (*Certification) Descriptor() ([]byte, []int) {
	return fileDescriptor_f0277fc1d2fabb3b, []int{15}
}
...
func (*RecruitingNote) Descriptor() ([]byte, []int) {
	return fileDescriptor_f0277fc1d2fabb3b, []int{16}
}
...
func (m *RecruitingNote) XXX_Merge(src proto.Message) {
	xxx_messageInfo_RecruitingNote.Merge(m, src)
}
