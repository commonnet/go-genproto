...
func (*ParseResumeRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_7192f4318f31f4cb, []int{0}
}
...
func (m *ParseResumeRequest) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ParseResumeRequest.Merge(m, src)
}
...
func (*ParseResumeOptions) Descriptor() ([]byte, []int) {
	return fileDescriptor_7192f4318f31f4cb, []int{1}
}
...
func (m *ParseResumeOptions) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ParseResumeOptions.Merge(m, src)
}
...
func (*ParseResumeResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_7192f4318f31f4cb, []int{2}
}
...
func (m *ParseResumeResponse) XXX_Merge(src proto.Message) {
	xxx_messageInfo_ParseResumeResponse.Merge(m, src)
}
...
func init() {
	proto.RegisterFile("google/cloud/talent/v4beta1/resume_service.proto", fileDescriptor_7192f4318f31f4cb)
}

var fileDescriptor_7192f4318f31f4cb = []byte{
